...
function ToggleComponent() {
  const [isToggled, toggle] = useToggle(true); // initial value is true

  return (
    <div className='my-40 text-center font-bold text-3xl'>
      <p className='mb-8 text-neutral-800'>The Situation: <span className='text-red-700'> {isToggled ? 'True' : 'False'}</span></p>
